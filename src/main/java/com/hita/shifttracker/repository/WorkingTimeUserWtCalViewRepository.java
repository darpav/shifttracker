...
@Repository
public interface WorkingTimeUserWtCalViewRepository extends CrudRepository<WorkingTimeUserWtCalView, Integer> {

    @Query("SELECT * FROM vw_working_time_user_wt_cal wtuv WHERE wtuv.us_code = :appUserCode AND wtuv.mjesec = :month")
    List<WorkingTimeUserWtCalView> findAllByAppUserCode(String appUserCode, int month);
//
